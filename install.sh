...
nginxBlog() {
	...
	if [[ -d "/usr/share/nginx/html" && -f "/usr/share/nginx/html/check" ]]; then
		...
		if [[ "${nginxBlogInstallStatus}" == "y" ]]; then
			...
			wget -q -P /usr/share/nginx https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/fodder/blog/unable/html${randomNum}.zip >/dev/null
...
#		rm -rf /usr/share/nginx/html
		...
		if wget --help | grep -q show-progress; then
			wget -c -q --show-progress -P /usr/share/nginx "https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/fodder/blog/unable/html${selectInstallNginxBlogType}.zip" >/dev/null
		else
			wget -c -P /usr/share/nginx "https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/fodder/blog/unable/html${selectInstallNginxBlogType}.zip" >/dev/null
		fi
...
updateV2RayAgent() {
	...
	if wget --help | grep -q show-progress; then
		wget -c -q --show-progress -P /etc/v2ray-agent/ -N --no-check-certificate "https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/install.sh"
	else
		wget -c -q -P /etc/v2ray-agent/ -N --no-check-certificate "https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/install.sh"
	fi
	...
	echoContent skyBlue "wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/15976770947/v2ray-ba-he-1/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh"
	echo
	exit 0
}
